  ...
  return (
    <div className='Carousel-Container'>
      ...
      <div className="wrapper" style={style}>
        ...
        <div className="Sider-Container">
          <div className="Img-container">
            <img src="https://www.vintageindustries.nl/download_front/qympzk1762/2217_Arrow_Jacket_Forest.png" alt="" />
          </div>
          <div className="Description">
            <div className="des-wrapper">
            <h1>Lorem ipsum dolor sit amet</h1>
        ...
        <div className="Sider-Container">
          <div className="Img-container">
            <img src="https://static.wixstatic.com/media/c6dc2b_93e69491181a4784bacf188699b6491d~mv2.jpg/v1/fill/w_1349,h_500,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/c6dc2b_93e69491181a4784bacf188699b6491d~mv2.jpg" alt="" />
          </div>
          <div className="Description">
            <div className="des-wrapper">
            <h1>Lorem ipsum dolor sit amet</h1>
      ...
      <div className="Arrow-Container right" onClick={() =>handleSlide("right")}>
